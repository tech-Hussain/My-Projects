 ...
 * @callback onData
 * @param {percentage} percentage percentage of the process
 * @param {number} id identifier of the process
 * @returns {void}
 */
...
const convertVideo = async (options, onData, onClose) => {
    try {
        ...
        ffmpegProcess.stdio[3].on("data", () => {
            ...
            const percentage = ((videoTotal + audioTotal) / 2)
            if (onData) onData({ total: percentage, videoTotal, audioTotal }, id)
        })
