# CONVERT TEMPERATURE DEGREE CELSIUS TO FAHRENHEIT

# celsTemp=int(input("Enter the Temperature in Celsius: "))
# fahrTemp=(celsTemp * (9/5)) + 32
# print(f"The {celsTemp}\N{DEGREE SIGN}C is equal to {fahrTemp}\N{DEGREE SIGN}F")

# CONVERT TEMPERATURE DEGREE FAHRENHEIT TO CELSIUS

# fahrTemp=int(input("Enter the Temperature in Fahrenheit: "))
# celsTemp=round(((fahrTemp-32) * 5/9),2)
